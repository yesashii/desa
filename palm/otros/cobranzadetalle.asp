...
sql="select d.AUX_VALOR3 as Cliente, d.nreferencia as Factura, max(d.condpago) as condpago, sum(d.debe_ingreso-d.haber_ingreso) as Saldo " & _
	...
	"where d.AUX_VALOR3='" & cl & "' " & _
	"group by d.AUX_VALOR3,d.nreferencia " & _
