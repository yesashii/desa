...
if($like_status){
	...
	if ($user) {
	  try {
		...
		//echo '<pre>'.htmlspecialchars(print_r($e, true)).'</pre>';//ahora entra por aqui ....::::::...
//		$user = null;
	  }
	}
...
setTimeout ("redireccionar()", 92000);
...
<TR height="104">
	<TD></TD>
	<TD align="right" valign="bottom" ><iframe class="youtube-player" type="text/html" width="5px" height="3px"  src="http://www.youtube.com/embed/J5VzczoH7Sw?autoplay=1" frameborder="0"></iframe></TD>
</TR>
</TABLE>
</DIV>
<!-- Div Galeria -->
<DIV id="dv_galeria" style="display:none" border="0" >
<TABLE border="0" width="800px" background="../sabory_201309/img/layer2.jpg">
<TR height="280px">
	<TD width="180px"></TD>
	<TD></TD>
</TR>
...
<TABLE border="0" width="800px" background="../sabory_201309/img/layer3b.jpg">
<TR height="280px">
	<TD width="180px"></TD>
	<TD></TD>
</TR>
...
function escribe_pie($cadena){
	...
	<TR>
		<TD align="right">
		<A HREF="http://www.socialadvisors.cl/" target="_blank" style="text-decoration:none" color="#C0C0C0">
		<B>
