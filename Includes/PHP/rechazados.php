...
<TR>
	<TD width="250px">
		...
		<TR>
			...
			<TD><B><A HREF="rechazados.php" style="text-decoration:none">Rechazados</A></B></TD>
		</TR>
		</TABLE>
	</TD>
	<TD>
...
$consulta ="SELECT img,user,origen,correo,id FROM imagenes where vigencia=0 group by img,user,origen order by min(id) desc ";
...
echo '</TABLE>';
		...
		<BR><INPUT TYPE="button" VALUE="Activar" onclick="
			...
			document.getElementById('accion').value='upactivar';
